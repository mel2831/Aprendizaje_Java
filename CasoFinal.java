...
public class CasoDetective
{
    ...
    public static void main(String[] args) 
    {
        ...
        System.out.println("Estos son los posibles sospechosos");
        System.out.println("1. James Barnes");
        System.out.println("2. Aurelio Vásquez");
        System.out.println("3. Victoria Reyes");
        System.out.println("4. Bruno Quiroga");
        System.out.println("¿Quién Crees que es el asesino?");
        posibleSospechoso= teclado.nextInt();
        ...
        do 
        {
            ...
            switch (opcion) 
            {
                ...
                case 1:
                    ...
                    System.out.println("¿Quieres ver más pistas");
                    decision= teclado.nextLine();
                    
                    if(decision.equals("si")){
                    String[] Evidencias = 
                    {
                        "La huella no es de Victoria",
                        "La letra en la nota rasgada coincide con la de Aurelio",
                        "El cuchillo lo cogió un hombre"
                    };
                    int t=0;
                    while (t < Evidencias.length) 
                    {
                       pistas++;
                        System.out.println("  Pista #" + pistas + ": " + Evidencias[t]);
                        t++; 
                    }  
                    }
